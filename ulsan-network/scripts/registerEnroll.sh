...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:ppworg1@localhost:7054 --caname ca-org1 --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:ppworg2a@localhost:8054 --caname ca-org2 --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg3() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:ppworg3b@localhost:11054 --caname ca-org3 --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  { set +x; } 2>/dev/null
